...
void Grenades::paint( ) {
	...
	if( !g_hooks.b[ XOR( "grenadeTrajectory" ) ] )
		return;
	...
	for( const auto& cur : m_path ) {
		...
		if( render::WorldToScreen( prev, screen0 ) && render::WorldToScreen( cur, screen1 ) )
			render::line( screen0, screen1, { ( int )( g_hooks.c[ XOR( "grenadeTrajectory_color" ) ][ 0 ] * 255.f ), ( int )( g_hooks.c[ XOR( "grenadeTrajectory_color" ) ][ 1 ] * 255.f ), ( int )( g_hooks.c[ XOR( "grenadeTrajectory_color" ) ][ 2 ] * 255.f ), ( int )( g_hooks.c[ XOR( "grenadeTrajectory_color" ) ][ 3 ] * 255.f ) } );
