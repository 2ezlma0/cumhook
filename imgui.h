...
namespace ImGui
{
    ...
    IMGUI_API void          PushDisabled( );                                // width of items for the common item+label case, pixels. 0.0f = default to ~2/3 of windows width, >0.0f: width in pixels, <0.0f align xx pixels to the right of window (so -1.0f always align width to the right side)
    IMGUI_API void          PopDisabled( );                                // width of items for the common item+label case, pixels. 0.0f = default to ~2/3 of windows width, >0.0f: width in pixels, <0.0f align xx pixels to the right of window (so -1.0f always align width to the right side)
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0, int = 1);
    ...
    IMGUI_API bool			MultiComboNew(const char* name, const char** displayName, bool* data, int dataSize, std::unordered_map<int, bool>* data1, std::vector<const char*> items);
