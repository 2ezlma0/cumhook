...
void ImGui::EndGroupBox()
{
	...
	if (window->ScrollbarY) {
		...
		if (window->Scroll.y > 1.0f) {
			...
			window->DrawList->AddRectFilledMultiColor(minTop + ImVec2(2, 1), maxTop + ImVec2(1, -13), ImColor(48, 48, 48, int( g.Style.Alpha * 255 ) ), ImColor(48, 48, 48, int( g.Style.Alpha * 255 ) ), ImColor(48, 48, 48, int( g.Style.Alpha * 255 ) ), ImColor(48, 48, 48, int( g.Style.Alpha * 255 ) ));
			window->DrawList->AddRectFilledMultiColor(minTop + ImVec2(2, 2), maxTop + ImVec2(1, 4), ImColor(17, 17, 17, int( g.Style.Alpha * 255 ) ), ImColor(17, 17, 17, int( g.Style.Alpha * 255 ) ), ImColor(17, 17, 17, 0), ImColor(17, 17, 17, 0));
			//RenderText(ImVec2(maxTop.x - 18, maxTop.y - 16), "B");

            window->DrawList->AddRect(ImVec2(maxTop.x - 13, maxTop.y - 5), maxTop + ImVec2(-17, -4), ImColor(0, 0, 0, int( g.Style.Alpha * 255 ) ));
            window->DrawList->AddRect(ImVec2(maxTop.x - 13, maxTop.y - 6), maxTop + ImVec2(-17, -5), ImColor(255, 255, 255, int( g.Style.Alpha * 255 ) ));
            window->DrawList->AddRect(ImVec2(maxTop.x - 14, maxTop.y - 7), maxTop + ImVec2(-16, -6), ImColor(255, 255, 255, int( g.Style.Alpha * 255 ) ));
            window->DrawList->AddRect(ImVec2(maxTop.x - 15, maxTop.y - 8), maxTop + ImVec2(-15, -7), ImColor(255, 255, 255, int( g.Style.Alpha * 255 ) ));
		}

		if ((GetScrollMaxY() - window->Scroll.y) > 1.f) {

			window->DrawList->AddRectFilledMultiColor(minBottom + ImVec2(2, 13), maxBottom + ImVec2(6, 20), ImColor(48, 48, 48, int( g.Style.Alpha * 255 ) ), ImColor(48, 48, 48, int( g.Style.Alpha * 255 ) ), ImColor(48, 48, 48, int( g.Style.Alpha * 255 ) ), ImColor(48, 48, 48, int( g.Style.Alpha * 255 ) ));
			window->DrawList->AddRectFilledMultiColor(minBottom + ImVec2(2, -2), maxBottom + ImVec2(6, -2), ImColor(17, 17, 17, 0), ImColor(17, 17, 17, 0), ImColor(17, 17, 17, int( g.Style.Alpha * 255 ) ), ImColor(17, 17, 17, int( g.Style.Alpha * 255 ) ));
			//RenderText(ImVec2(maxBottom.x - 18, maxBottom.y - 18), "A");

            window->DrawList->AddRect(ImVec2(maxBottom.x - 13,maxBottom.y - 11), maxBottom + ImVec2(-17, -10), ImColor(0, 0, 0, int( g.Style.Alpha * 255 ) ));
            window->DrawList->AddRect(ImVec2(maxBottom.x - 13,maxBottom.y - 10), maxBottom + ImVec2(-17, -9), ImColor(255, 255, 255, int( g.Style.Alpha * 255 ) ));
            window->DrawList->AddRect(ImVec2(maxBottom.x - 14,maxBottom.y - 9), maxBottom + ImVec2(-16, -8), ImColor(255, 255, 255, int( g.Style.Alpha * 255 ) ));
            window->DrawList->AddRect(ImVec2(maxBottom.x - 15,maxBottom.y - 8), maxBottom + ImVec2(-15, -7), ImColor(255, 255, 255, int( g.Style.Alpha * 255 ) ));
...
bool ImGui::GroupBoxTitleEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags) {
	...
	auto topColor = ImColor(170, 170, 170, int( g.Style.Alpha * 255 ) );
	auto bottomColor = ImColor(170, 170, 170, int( g.Style.Alpha * 255 ) );
...
bool ImGui::BeginColorPickerBackground(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
	...
	if (first_begin_of_the_frame)
	{
		...
		{
			// Window background
			auto backgroundColor = ImColor(40, 40, 40, int( g.Style.Alpha * 255 ) );
			auto borderColor = ImColor(10, 10, 10, int( g.Style.Alpha * 255 ) );
			auto innerBorderColor = ImColor(60, 60, 60, int( g.Style.Alpha * 255 ) );
...
bool ImGui::BeginTabsBackground(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
	...
	if (first_begin_of_the_frame)
	{
		...
		else
		{
            ...
            //window->DrawList->AddRect( window->Pos + ImVec2( 74, window->TitleBarHeight( ) - 1 ), window->Pos + window->Size - ImVec2( 0, 530 ), outerBorderColor, 0, false, 0.4 );
            //window->DrawList->AddRect( window->Pos + ImVec2( 73, window->TitleBarHeight( ) - 1 ), window->Pos + window->Size - ImVec2( 1, 530 ), innerBorderColor, 0, false, 0.4 );
            //window->DrawList->AddRect( window->Pos + ImVec2( 72, window->TitleBarHeight( ) - 1 ), window->Pos + window->Size - ImVec2( 2, 530 ), backgroundColor, 0, false, 0.4 );
...
bool ImGui::BeginEndBorder(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
	...
	if (first_begin_of_the_frame)
	{
		...
		else
		{
			...
			auto innerBorderColor = ImColor(255, 255, 255, int( g.Style.Alpha * 255 ) );
...
bool ImGui::BeginShadowBackground(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
	...
	if (first_begin_of_the_frame)
	{
		...
		{
			// Window background
			auto topColor = ImColor(40, 40, 40, int( g.Style.Alpha * 255 ) );
			auto bottomColor = ImColor(49, 49, 49, int( g.Style.Alpha * 255 ) );
...
bool ImGui::BeginGroupBoxMain(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
	...
	if (first_begin_of_the_frame)
	{
		...
		{
			auto backgroundColor = ImColor(17, 17, 17, int( g.Style.Alpha * 255 ) );
			auto innerBorderColor = ImColor(48, 48, 48, int( g.Style.Alpha * 255 ) );
			auto outerBorderColor = ImColor(10, 10, 10, int( g.Style.Alpha * 255 ) );
...
bool ImGui::BeginGroupBoxScrollMain(const char* name, const char* groupboxName, bool* p_open, ImGuiWindowFlags flags)
{
	...
	if (first_begin_of_the_frame)
	{
		...
		{
			auto backgroundColor = ImColor(17, 17, 17, int( g.Style.Alpha * 255 ) );
			auto backgroundColor2 = ImColor(17, 17, 170, int( g.Style.Alpha * 255 ) );
			auto innerBorderColor = ImColor(48, 48, 48, int( g.Style.Alpha * 255 ) );
			auto outerBorderColor = ImColor(10, 10, 10, int( g.Style.Alpha * 255 ) );
...
bool ImGui::BeginComboBackground(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
	...
	if (first_begin_of_the_frame)
	{
		...
		{
			auto borderColor = ImColor(10, 10, 10, int( g.Style.Alpha * 255 ) );
			auto backgroundColor = ImColor(35, 35, 35, int( g.Style.Alpha * 255 ) );
...
void ImGui::PushDisabled( ) {
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    if( ( window->DC.ItemFlags & ImGuiItemFlags_Disabled ) == 0 )
